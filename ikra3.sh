...
Usage: ${PROGNAME} experiment_table.csv --transcript [--test --fastq, --help, --without-docker, --udocker, --protein-coding][--genome [VALUE]] [--threads [VALUE]][--output [VALUE]][--suffix_PE_1 [VALUE]][--suffix_PE_2 [VALUE]]
  args
    1.experiment matrix(csv)
    2.reference(human or mouse)
Options:
  --transcript refference transcript
